    ...
    static func getElementsList() -> [Element] {
        [
            ...
            Element(symbol: "Vitamin D",
                    ...
                    ruName: "Витамин D",
                    type: "Vitamin",
                    elementInfo: "Витамин Д (кальциферол, антирахитический). Известны витамины Д2 (эргокальциферол) и Д3 (холекальциферол). Витамин Д3 образуется в коже под действием УФ-лучей из холестерина и поступает с рыбьим жиром, молоком, коровьим маслом, желтком яиц, печенью, рыбной мукой кормовыми дрожжами. Витамин Д откладывается в коже, где его в 2-3 раза больше, чем в крови и печени. Витамин Д3 преобладает в организме (85% всех витаминов) и из него синтезируется (в печени, почках) гормон кальцитриол, регулирующий обмен кальция и фосфора(2:1 или 1:1 - норма).",
