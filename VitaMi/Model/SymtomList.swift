...
struct Symtom: Identifiable {
    ...
    static func getSymptomsList() -> [Symtom] {
        [
            ...
            Symtom(enName: "bone and(or) join pain", ruName: "боль в костях и(или) суставах", elements: ["Ca", "Cu", "P", "Vitanim P", "Vitamin D"]),
            Symtom(enName: "dry skin", ruName: "сухость кожи", elements: ["Fe", "K", "Zn", "Vitanim B2", "Vitanim B9", "Vitamin A", "Vitamin F"]),
            ...
            Symtom(enName: "thirst", ruName: "жажда", elements: ["K", "Na"]),
            ...
            Symtom(enName: "depression", ruName: "депрессия", elements: ["K", "P", "Zn", "Vitamin D", "Vitamin D"]),
            ...
            Symtom(enName: "cold intoleranc", ruName: "непереносимость холода", elements: ["Fe", "Fe"]),
